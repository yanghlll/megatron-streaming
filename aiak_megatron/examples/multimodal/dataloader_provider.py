...
def is_first_or_last_stage(pp_size, encoder_pipeline_model_parallel_size):
    ...
    if encoder_pipeline_model_parallel_size == 0:
        ...
        # Separate pipeline stage for the vision model. Run the dataloader on
        # the first vision and LM stage and last LM stage.
...
class EnergonDataloader:
    ...
    def save_state(self):
        """save state of the underlying dataloader"""
