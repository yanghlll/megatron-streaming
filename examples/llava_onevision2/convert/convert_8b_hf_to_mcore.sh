# =============================================================================
# LLaVA-OneVision2 8B – Convert HuggingFace checkpoint to Megatron-Core
# =============================================================================
#
# Usage:
#   bash convert_8b_hf_to_mcore.sh <LOAD> <SAVE> <TP> <PP> [CUSTOM_PIPELINE_LAYERS]
#
# Arguments:
...
#
# Examples:
#   bash convert_8b_hf_to_mcore.sh /src /dst 2 4 0,12,12,12
#   bash convert_8b_hf_to_mcore.sh /src /dst 1 1
# =============================================================================
